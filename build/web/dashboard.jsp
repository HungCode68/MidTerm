                ...
                <form action="add-user" method="post" class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input name="fullName" id="fullName" class="form-control" placeholder="Enter full name" required>
                        </div>
                        <div class="form-group">
                            <label for="email">Email</label>
                            <input name="email" id="email" class="form-control" placeholder="Enter email" required>
                        </div>
                        <div class="form-group">
                            <label for="phoneNumber">Phone Number</label>
                            <input name="phoneNumber" id="phoneNumber" class="form-control" placeholder="Enter phone number" required>
                        </div>
                        <div class="form-group">
                            <label for="cccd">ID Card Number</label>
                            <input name="cccd" id="cccd" class="form-control" placeholder="Enter ID card number" required>
                        </div>
                        <div class="form-group">
                ...
                <form action="edit-user" method="post" class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input name="fullName" id="editFullName" class="form-control" placeholder="Enter full name" required>
                        </div>

                        <div class="form-group">
                            <label for="editEmail">Email</label>
                            <input name="email" id="editEmail" class="form-control" placeholder="Enter email" required>
                        </div>

                        <div class="form-group">
                            <label for="editPhoneNumber">Phone Number</label>
                            <input name="phoneNumber" id="editPhoneNumber" class="form-control" placeholder="Enter phone number" required>
                        </div>

                        <div class="form-group">
                            <label for="editCCCD">ID Card Number</label>
                            <input name="cccd" id="editCCCD" class="form-control" placeholder="Enter ID card number" required>
                        </div>
