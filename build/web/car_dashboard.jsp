...
<html>
    ...
    <body>
        ...
        <div >
            <h2 class="text-center mb-4">Vehicle List Management</h2>
                ...
                <form action="add-car" method="post" class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input name="modelName" id="modelName" class="form-control" placeholder="Enter car name" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input name="imageUrl" id="imageUrl" class="form-control" placeholder="Enter image URL" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="specifications" id="specifications" class="form-control" placeholder="Enter specifications" required></textarea>
                        </div>
                    </div>
            ...
            <div class="modal-dialog" role="document">
                <form action="edit-car" method="post" class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="editModelName">Car Name</label>
                            <input name="modelName" id="editModelName" class="form-control" placeholder="Enter car name" required>
                        </div>
                        <div class="form-group">
                            <label for="editPrice">Price</label>
                            <input name="price" type="number" step="0.01" id="editPrice" class="form-control" placeholder="Enter price" required>
                        </div>
                        <div class="form-group">
                            <label for="editImageUrl">Image URL</label>
                            <input name="imageUrl" id="editImageUrl" class="form-control" placeholder="Enter image URL" required>
                        </div>
                        <div class="form-group">
                            <label for="editDescription">Description</label>
                            <textarea name="description" id="editDescription" class="form-control" placeholder="Enter description" required></textarea>
                        </div>
                        <div class="form-group">
                            <label for="editSpecifications">Specifications</label>
                            <textarea name="specifications" id="editSpecifications" class="form-control" placeholder="Enter specifications" required></textarea>
                        </div>
                    </div>
                    <div class="modal-footer">
