<%-- 
    Document   : consultation_form
    Created on : Jun 18, 2025, 10:10:59 AM
    Author     : Nguyễn Hùng
--%>
...
<%
    ...
    // Lấy danh sách xe từ request (đã set từ Servlet trước đó)
    ...
    <body>
        ...
        <div class="main-container">
            ...
            <div class="image-container">
                <img src="https://shop.vinfastauto.com/on/demandware.static/-/Sites-app_vinfast_vn-Library/default/dw174b57d5/images/PDP/vf9/202406/hero.webp" alt="VinFast VF3" />
            </div>

            <div class="form-container">
                <h2>Đăng ký tư vấn xe điện</h2>
                ...
                <form action="consultations" method="post">
                    <label for="carId">Chọn mẫu xe bạn muốn được tư vấn:</label>
                    <select name="carId" id="carId" required>
                        <% if (cars != null) {
                for (Car car : cars) { %>
                        <option value="<%= car.getCarId() %>"><%= car.getModelName() %> - <%= car.getDescription() %></option>
                        <%  }
            } else { %>
                        <option disabled>Không có xe nào để hiển thị</option>
                        <% } %>
                    </select>
